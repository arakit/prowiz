...
public class DeckManager {
	...
	public static class DItem implements Serializable{
		...
		public DItem(String title,int icon,int category,int lv,int atk, int num, int num_limit) {
	...
	public synchronized boolean update_kari(LoginInfo l){
		...
		try {
			...
			int icon = R.drawable.ic_launcher;//((BitmapDrawable) mContext.getResources().getDrawable(R.drawable.ic_launcher)).getBitmap();
